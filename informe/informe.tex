...
El sistema de recomendación difuso propuesto se compone de cuatro módulos principales que permiten su
funcionamiento. Estos son:

\begin{enumerate}
    \item \textbf{Lector de datasets}: La etapa inicial en el análisis de sentimientos consiste en la lectura y
			procesamiento del conjunto de datos. En este caso, se utiliza un dataset de sentimientos extraídos de tweets, el cual está estructurado específicamente para facilitar el análisis de emociones y opiniones.
	...
	\item \textbf{Benchmarks}: Para evaluar el rendimiento del sistema de recomendación difuso, se utilizan benchmarks.
...
\begin{enumerate}
	...
	\item \textbf{Fuzzificación}: La fuzzificación es el paso inicial en un sistema de lógica difusa.
		  ...
		  \item \textbf{Sistema de Reglas Difusas}:
	...
	\item \textbf{Defusificador}: La defuzzificación es el procedimiento mediante el cual las salidas difusas del sistema
	...
	\item \textbf{Benchmarks}: Para medir el desempeño del sistema, se analizaron métricas relacionadas
