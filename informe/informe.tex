...
\begin{enumerate}
    ...
    \item \textbf{Sistema de inferencia difuso}: Este módulo aplica un sistema de inferencia basado en lógica difusa a 
	las variables de entrada ya procesadas, con el objetivo de generar una salida difusa que capture la relación entre 
	las mismas.
